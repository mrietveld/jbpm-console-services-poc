...
public interface TaskWebService {
    ...
    @RequestWrapper(localName = "taskOperation", targetNamespace = NAMESPACE, className = "org.kie.services.remote.ws.wsdl.generated.WrapperTaskOperation")
    @ResponseWrapper(localName = "taskOperationResponse", targetNamespace = "http://services.remote.kie.org/process", className = "org.kie.services.remote.ws.wsdl.generated.WrapperTaskOperationResponse")
