...
public class ArquillianIntegrationTest {
    ...
    public static Archive<?> importDeployment() {
        String warPath = "target/jms-impl-0.0.1-SNAPSHOT.war";
    ...
    public static Archive<?> createDeployment() {
        ...
        File[] libs = Maven
                ...
                .resolve(
                        ...
                        // jbpm/kie
                        "org.jbpm:jbpm-persistence-jpa", "org.jbpm:jbpm-runtime-manager", "org.kie:kie-api",
                        "org.kie:kie-internal",
                        // specs/jboss/persistence
                        "org.jboss.spec.javax.ejb:jboss-ejb-api_3.1_spec", "org.hiberate:hibernate-entitymanager:4.1.6.Final",
                        "org.hiberate:hibernate-core:4.1.6.Final", "org.hibernate.javax.persistence:hibernate-jpa-2.0-api")
        ...
        return ShrinkWrap.create(WebArchive.class).addAsResource(EmptyAsset.INSTANCE, "beans.xml").addAsLibraries(libs);
    }
