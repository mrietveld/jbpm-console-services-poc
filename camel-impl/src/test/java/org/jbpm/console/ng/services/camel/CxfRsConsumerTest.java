...
import org.jbpm.console.ng.services.rest.test.CustomerServiceResource;
import org.junit.Test;


public class CxfRsConsumerTest extends CamelTestSupport {
    private static final String PUT_REQUEST = "<Customer><name>Mary</name><id>123</id></Customer>";
    private static final String CXT = AvailablePortFinder.getNextAvailable() + "/" + CxfRsConsumerTest.class.getSimpleName();
    // START SNIPPET: example
    private static final String CXF_RS_ENDPOINT_URI = "cxfrs://http://localhost:" + CXT + "/rest?resourceClasses=" + CustomerServiceResource.class.getCanonicalName();
    ...
    private String invokeGetCustomer(String uri) throws Exception {
    ...
    public void testGetCustomer() throws Exception {
        String uri = "http://localhost:" + CXT + "/rest/customerservice/customers/126";
        invokeGetCustomer(uri);
        uri = "http://localhost:" + CXT + "/rest/customerservice/customers/123";
        invokeGetCustomer(uri);
        uri = "http://localhost:" + CXT + "/rest/customerservice/customers/400";
        invokeGetCustomer(uri);
    }
