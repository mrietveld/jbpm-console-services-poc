...
public interface FluentKieSessionRequest {
     ...
     */
    FluentKieSessionRequest startProcess(String processId);
     ...
     *         the process that was started
     */
    FluentKieSessionRequest startProcess(String processId, Map<String, Object> parameters);
     ...
     */
    FluentKieSessionRequest createProcessInstance(String processId, Map<String, Object> parameters);
     ...
     *         the process that was started
     */
    FluentKieSessionRequest startProcessInstance(long processInstanceId);
     ...
     */
    FluentKieSessionRequest signalEvent(String type, Object event);
     ...
     */
    FluentKieSessionRequest signalEvent(String type, Object event, long processInstanceId);
     ...
     */
    FluentKieSessionRequest getProcessInstanceStatuses();
     ...
     *         cannot be found
     */
    FluentKieSessionRequest getProcessInstanceStatus(long processInstanceId);
     ...
     *         cannot be found
     */
    FluentKieSessionRequest getProcessInstance(long processInstanceId, boolean readonly);
     ...
     *            the id of the process instance
     */
    FluentKieSessionRequest abortProcessInstance(long processInstanceId);
