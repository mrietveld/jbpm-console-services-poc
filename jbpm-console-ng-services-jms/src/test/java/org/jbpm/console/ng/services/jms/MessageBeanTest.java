 ...
 *      <ul><code>&lt;jmx-management-enabled&gt;true&lt;/jmx-management-enabled&gt;</code></ul>
...
//@ServerSetup(MessageBeanTest.MessageBeanTestSetup.class)
public class MessageBeanTest {
    ...
    private static final String TASK_QUEUE_NAME = "jms/queue/JBPM.TASK.DOMAIN";
    private static final String KSESSION_QUEUE_NAME = "jms/queue/JBPM.SESSION.DOMAIN";
    
    /**
     * This method reads the arquillian.launch file in src/test/resources -- well, 
     * actually, it reads the one that has already been processed and placed in the build directory. 
     * </p>
     * Depending on the maven profile being run, this file is filled with the name of the arquillian profile 
     * (in the arquillian.xml file) that should be used to run the test. 
     * </p>
     * The project is setup this way so that we can run tests against both jboss and glassfish(-embedded). 
     * @return A {@link Properties} object with one key, the name of the arquillian profile being used.
     */
    public static Properties getArquillianLaunchProperties() {
        Properties properties = new Properties();
        try {
            InputStream arquillianLaunchFile = MessageBeanTest.class.getResourceAsStream("/arquillian.launch");
     ...
     * </p>
     * This class is used to deploy and create the JMS queues that both this test and the 
     * main classes in this module expect to exist in the application server. 
     * </p>
     */
    public static class MessageBeanTestSetup implements ServerSetupTask {
        ...
        public void setup(ManagementClient managementClient, String containerId) throws Exception {
            ...
            if (arquillianLaunchProperties.containsKey("glassfish-embedded")) {
                ...
                URL hornetqJmsXmlUrl = MessageBeanTest.class.getResource(HORNETQ_JMS_XML);
...
//                getRemoteInitialContext();
    ...
    /**
     * Reads the properties for a (remote) InitialContext from the (filtered src/test/resources/)initalContext.properties
     * file and intializes a (remote) IntialContext instance.
    ...
    private static InitialContext getRemoteInitialContext() {
        ...
        Properties properties = new Properties();
        try {
            InputStream initialContextProperties = MessageBeanTest.class.getResourceAsStream(initalPropertiesFileName);
    ...
    public static Archive<?> createDeployment() {
        ...
        return ShrinkWrap.create(WebArchive.class)
                .addClasses(KnowledgeSessionMessageBean.class, TaskMessageBean.class, DomainQueueBean.class)
